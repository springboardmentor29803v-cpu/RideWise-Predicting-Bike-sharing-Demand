...
# LOAD MODEL & SCALER
# -------------------------------------------------------
model = pickle.load(open(r"C:\Users\palla\OneDrive\Desktop\Project\Models\RandomForest.pkl", "rb"))
scaler = pickle.load(open(r"C:\Users\palla\OneDrive\Desktop\Project\scaler.pkl", "rb"))
